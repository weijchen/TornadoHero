    ...
    public class TutorialManager : MonoBehaviour
    {
        ...
        public void CheckPlayProgress()
        {
            ...
            else if (tutorialStep == 1)
            {
                ...
                if (GameManager.Instance.rightHandDevice.TryGetFeatureValue(CommonUsages.triggerButton,
            ...
            else if (tutorialStep == 2)
            {
                ...
                if (GameManager.Instance.rightHandDevice.TryGetFeatureValue(CommonUsages.gripButton,
                        out bool gripValue) &&
                    gripValue)
                {
                    tutorialStep += 1;
            ...
            else if (tutorialStep == 7)
            {
                ...
                if (GameManager.Instance.leftHandDevice.TryGetFeatureValue(CommonUsages.triggerButton,
                        out bool triggerValue) &&
                    triggerValue)
                {
                    tutorialStep += 1;
            ...
            else if (tutorialStep == 8)
            {
                ...
                if (GameManager.Instance.leftHandDevice.TryGetFeatureValue(CommonUsages.gripButton,
                        out bool gripLValue) &&
                    gripLValue &&
                    GameManager.Instance.rightHandDevice.TryGetFeatureValue(CommonUsages.gripButton,
                        out bool gripRValue) &&
                    gripRValue)
                {
                    tutorialStep += 1;
